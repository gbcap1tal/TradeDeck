...
const SECTORS_DATA = [
  { name: 'Technology', ticker: 'XLK', color: '#0a84ff', industries: ['Software-Infrastructure', 'Semiconductors', 'Software-Application', 'IT Services', 'Electronic Components', 'Computer Hardware', 'Data Storage', 'Cybersecurity', 'Cloud Computing', 'Consumer Electronics'] },
  { name: 'Financials', ticker: 'XLF', color: '#30d158', industries: ['Banks-Regional', 'Insurance', 'Asset Management', 'Capital Markets', 'Financial Data', 'Credit Services', 'Mortgage Finance', 'Insurance Brokers'] },
  { name: 'Healthcare', ticker: 'XLV', color: '#ff453a', industries: ['Biotechnology', 'Medical Devices', 'Pharmaceuticals', 'Health Information', 'Diagnostics', 'Healthcare Plans', 'Medical Distribution', 'Drug Manufacturers'] },
  { name: 'Energy', ticker: 'XLE', color: '#ffd60a', industries: ['Oil & Gas E&P', 'Oil & Gas Equipment', 'Oil Refining', 'Renewable Energy', 'Natural Gas', 'Oil & Gas Midstream', 'Uranium', 'Coal'] },
  { name: 'Consumer Discretionary', ticker: 'XLY', color: '#bf5af2', industries: ['Internet Retail', 'Restaurants', 'Specialty Retail', 'Auto Manufacturers', 'Apparel', 'Home Improvement', 'Travel & Leisure', 'Gambling', 'Luxury Goods', 'Auto Parts'] },
  { name: 'Consumer Staples', ticker: 'XLP', color: '#ff9f0a', industries: ['Beverages', 'Household Products', 'Packaged Foods', 'Food Distribution', 'Tobacco', 'Personal Products', 'Discount Stores', 'Farm Products'] },
  { name: 'Industrials', ticker: 'XLI', color: '#64d2ff', industries: ['Aerospace & Defense', 'Railroads', 'Construction', 'Waste Management', 'Engineering', 'Airlines', 'Trucking', 'Marine Shipping', 'Staffing', 'Conglomerates'] },
  { name: 'Materials', ticker: 'XLB', color: '#ffd60a', industries: ['Specialty Chemicals', 'Gold', 'Steel', 'Building Materials', 'Paper & Packaging', 'Silver', 'Aluminium', 'Copper', 'Lumber & Wood', 'Industrial Gases'] },
  { name: 'Real Estate', ticker: 'XLRE', color: '#32ade6', industries: ['REIT-Residential', 'REIT-Industrial', 'REIT-Office', 'REIT-Healthcare', 'Real Estate Services', 'REIT-Retail', 'REIT-Specialty', 'REIT-Hotel'] },
  ...
  { name: 'Communication Services', ticker: 'XLC', color: '#bf5af2', industries: ['Internet Content', 'Telecom Services', 'Entertainment', 'Advertising', 'Publishing', 'Gaming', 'Streaming', 'Social Media'] },
];
