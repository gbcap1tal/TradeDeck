...
const SENTIMENT_PATTERNS: Array<{ pattern: RegExp; type: SentimentType }> = [
  { pattern: /\braises? (?:guidance|outlook)\b/gi, type: 'positive' },
  { pattern: /\babove (?:consensus|expectations)\b/gi, type: 'positive' },
  { pattern: /\btopped estimates\b/gi, type: 'positive' },
  { pattern: /\brecord (?:revenue|earnings)\b/gi, type: 'positive' },
  { pattern: /\bupside guidance\b/gi, type: 'positive' },
  { pattern: /\bbetter than\b/gi, type: 'positive' },
  { pattern: /\breaffirms? guidance\b/gi, type: 'positive' },
  { pattern: /\bbeats?\b/gi, type: 'positive' },
  { pattern: /\bupside\b/gi, type: 'positive' },
  { pattern: /\bexceeded\b/gi, type: 'positive' },
  { pattern: /\bupgraded\b/gi, type: 'positive' },
  { pattern: /\baccelerating\b/gi, type: 'positive' },
  { pattern: /\bstrong\b/gi, type: 'positive' },
  { pattern: /\blowers? (?:guidance|outlook)\b/gi, type: 'negative' },
  { pattern: /\bcuts? guidance\b/gi, type: 'negative' },
  { pattern: /\bbelow (?:consensus|expectations)\b/gi, type: 'negative' },
  { pattern: /\bfell short\b/gi, type: 'negative' },
  { pattern: /\bprofit warning\b/gi, type: 'negative' },
  { pattern: /\bdownside guidance\b/gi, type: 'negative' },
  { pattern: /\bwithdraws? guidance\b/gi, type: 'negative' },
  { pattern: /\bworse than\b/gi, type: 'negative' },
  { pattern: /\bmiss(?:es)?\b/gi, type: 'negative' },
  { pattern: /\bdownside\b/gi, type: 'negative' },
  { pattern: /\bweak\b/gi, type: 'negative' },
  { pattern: /\bdisappointing\b/gi, type: 'negative' },
  { pattern: /\bwarning\b/gi, type: 'negative' },
  { pattern: /\bdowngraded\b/gi, type: 'negative' },
  { pattern: /\bdecelerating\b/gi, type: 'negative' },
  { pattern: /\bmixed results\b/gi, type: 'neutral' },
  { pattern: /\breiterates? guidance\b/gi, type: 'neutral' },
  { pattern: /\bmaintains? outlook\b/gi, type: 'neutral' },
